      ...
      <IonContent fullscreen className="ion-padding" scroll-x="false">
        ...
        <IonRow>
          ...
          <IonSlide className="ion-text-start">
            ...
            <li>
              <ul>an integer, or</ul>
              <ul>the keyword <code>random</code>, for which we will try to return a random available fact, or</ul>
              <ul>a day of year in the form <code><strong>month</strong>/<strong>day</strong></code> (eg. <code>2/29</code>, <code>1/09</code>, <code>04/1</code>), if <strong><code>type</code></strong> is <code>date</code></ul>
              <ul><a href="#batching">ranges of numbers</a></ul>
            </li>
            {/* </IonList> */}
            <div>
